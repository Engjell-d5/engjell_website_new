      ...
      <main className="classic-panel md:col-span-9 flex flex-col bg-[#02141d] min-h-[80vh]">
        ...
        <div className="h-14 border-b border-[#1a3a4a] flex items-center justify-between px-8 shrink-0 bg-[var(--rich-black)]">
          <div className="flex items-center gap-3 text-xs text-gray-400">
            ...
            <span className="text-white font-medium uppercase tracking-widest font-montserrat text-[11px]">Portfolio</span>
          </div>
        ...
        <div className="p-6 md:p-10">
          <section className="animate-slide-up">
            ...
            <div className="mb-10 w-full h-64 rounded-sm overflow-hidden border border-[#1a3a4a] relative group">
              <Image 
                src="/IMG_7944.jpeg" 
                alt="Working" 
                fill
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Venture 1: Division5 */}
              <a href="https://division5.co" target="_blank" rel="noopener noreferrer" className="group relative h-[300px] border border-[#1a3a4a] overflow-hidden hover:border-[var(--primary-mint)] transition-all">
                <Image 
              ...
              <a href="https://divisionai.co" target="_blank" rel="noopener noreferrer" className="group relative h-[300px] border border-[#1a3a4a] overflow-hidden hover:border-white transition-all">
                <Image 
              ...
              <a href="https://division3d.co" target="_blank" rel="noopener noreferrer" className="group relative h-[300px] border border-[#1a3a4a] overflow-hidden hover:border-white transition-all md:col-span-2">
                <Image 
