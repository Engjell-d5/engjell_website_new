  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {unreadCount > 0 && (
          <div className="flex items-center gap-2 px-4 py-2 bg-yellow-500/20 border border-yellow-500/30 rounded">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
            {selectedMessage ? (
              ...
              <div className="classic-panel p-6 bg-[var(--rich-black)] border border-[#1a3a4a] flex items-center justify-center h-full min-h-[400px]">
