      ...
      <main className="classic-panel md:col-span-9 flex flex-col bg-[#02141d] min-h-[80vh]">
        ...
        <div className="h-14 border-b border-[#1a3a4a] flex items-center justify-between px-8 shrink-0 bg-[var(--rich-black)]">
          <div className="flex items-center gap-3 text-xs text-gray-400">
            ...
            <span className="text-white font-medium uppercase tracking-widest font-montserrat text-[11px]">About Me</span>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8 max-w-4xl mx-auto">
              ...
              <div className="prose prose-invert max-w-none text-gray-300 font-light text-sm leading-7">
                <p className="mb-6 first-letter:text-4xl first-letter:font-bold first-letter:text-white first-letter:mr-1 first-letter:float-left">
                  My work is grounded in the conviction that Tirana is fertile ground for world-class technology. Ten years ago, I stepped away from traditional education to build my own path. As a creative at heart, I fell in love with the act of building—whether it was software or companies. I failed more times than I succeeded, but those experiences shaped me into the entrepreneur I am today.
                </p>
                <p className="mb-6">
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-6 border border-[#1a3a4a] bg-[var(--rich-black)] hover:border-[var(--primary-mint)] transition-colors group">
                  ...
                  <div className="p-6 border border-[#1a3a4a] bg-[var(--rich-black)] hover:border-white transition-colors group">
                    <div className="flex items-center gap-3 mb-2">
