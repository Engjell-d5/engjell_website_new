...
export const BIOS = {
  short:
    'Engjell Rraklli is a tech entrepreneur in Tirana. He founded division5, a staffing marketplace placing vetted AI-native Balkan engineers with companies across Europe, and builds AI-powered business systems at divisionAI.',
  medium:
    'Engjell Rraklli is a tech entrepreneur based in Tirana, Albania. He founded division5 in 2015, today a staffing marketplace connecting vetted AI-native engineers across the Balkans with companies in Europe and beyond, and builds AI-powered business management systems at divisionAI. He writes about scaling service businesses and hosts the podcast Scaling the Unscalable.',
  long:
