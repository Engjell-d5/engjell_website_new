...
export default function ShareRow({ url, title }: { url: string; title: string }) {
  ...
  const btn =
    'flex items-center gap-2 px-3 py-2 border border-[var(--border-color)] text-gray-400 hover:text-[var(--primary-mint)] hover:border-[var(--primary-mint)] text-[10px] font-bold uppercase tracking-widest transition-colors';
