...
const BLURB =
  'Six diagnostics from eleven years of building a tech company in Albania, mostly by training people nobody else would hire. Ten pages, written to be worked through rather than read.';
